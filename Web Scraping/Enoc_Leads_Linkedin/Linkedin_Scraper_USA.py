...
class LinkedInBIMScraperFixed:
    def __init__(self):
        ...
        self.search_terms = [
            "BIM Modeler", "BIM Manager", "BIM Coordinator", "Civil works", "VDC", "Pipelines", "Oil & Gas",
            "BIM Designer", "Drafter Civil 3D", "BIM infrastructure tunnel", "Revit", "Civil Engineer", "Structural Designer",
            "Revit Modeler", "Revit Designer", "BIM infrastructure tunnel", "VDC Engineer",
            "Scan To BIM", "Reality Capture", "Civil Utilities Modeling"
        ]
        ...
        self.results = []
        self.max_posts_per_term = 100 
        self.max_pages = 20  # Páginas 
        self.max_posts_total = 1000  # Límite total 
